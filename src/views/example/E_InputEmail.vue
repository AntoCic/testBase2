    ...
    <div class="row justify-content-center text-center">
      ...
      <div class="col-12 text-start">
        ...
        <div class="input-group">
          <InputEmail field="emailX" v-model="form" label inputGroup :onChange="handleChange" />
          <Btn @click="form.reset()" googleIcon="replay"></Btn>
          <Btn type="submit" @click="handleSubmit" googleIcon="send"></Btn>
        </div>
        <hr>
        <p class="">{{ form.emailX }}</p>
        <hr>
...
import InputEmail from '../../personal_modules/form-validator/InputEmail.vue';
